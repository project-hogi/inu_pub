...
<div class="bizcool">
	...
	<div class="img-box" style="background-image: url(<?php echo $config["imageDir"]; ?>/part/content/education/bizcool-1.jpg);">
		<span class="text">
	...
	<div class="img-box" style="background-image: url(<?php echo $config["imageDir"]; ?>/part/content/education/bizcool-2.jpg);">
		<span class="text">
	...
	<div class="img-box" style="background-image: url(<?php echo $config["imageDir"]; ?>/part/content/education/bizcool-3.jpg);">
		<span class="text">
