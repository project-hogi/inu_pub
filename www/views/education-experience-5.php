...
<?php require "part/header-sub.php"; ?>
	<div class="bizcool boomup">
		...
		<div class="img-box" style="background-image: url(<?php echo $config["imageDir"]; ?>/part/content/education/boomup-1.jpg);">
			<span class="text">
			<img src="<?php echo $config["imageDir"]; ?>/part/content/education/bizcool-1-1.png" alt="">
			<span class="sr-only">01</span>
		</span>
		</div>
		<div class="img-box" style="background-image: url(<?php echo $config["imageDir"]; ?>/part/content/education/boomup-2.jpg);">
			<span class="text">
