...
<div class="board-incubating">
	<div class="board-incubating-list">
		<ul>
			<li>
				<div class="img-area">
				...
				<div class="pre-area">
					...
					<p class="name">대표자 : 홍길동 ㅣ 연락처 : 02-1234-3456</p>
	...
	<!-- /.board-incubating-list -->


	<!-- Modal -->
	<div class="modal fade" id="board-incubating-detail" role="dialog">
