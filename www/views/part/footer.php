...
<div id="footer">
	<div class="container">
		<div class="wrap">
			...
			<div class="sns">
				<ul>
					<li class="instagram"><a href="https://www.instagram.com/inustartup/"><span class="sr-only">인스타</span></a></li>
					<li class="facebook"><a href="https://www.facebook.com/inustartup/"><span class="sr-only">페이스북</span></a></li>
				</ul>
			</div>
		</div>
		<div class="wrap">
			<p class="contact">21999 인천광역시 연수구 갯벌로 송도테크노파크 미추홀타워 별관A동 504호 인천대학교 창업지원단 &nbsp; Tel : 032-835-9683 &nbsp; Fax : 032-835-4161</p>
			<p class="copyright">Copyright (c) 2016 Incheon National University. All Rights Reserved.</p>
